const ODIN_TREE_DATA = [
  { group:"SYSTEM", items:[
    {id:"dashboard", title:"Dashboard", path:"ODIN SYSTEM", type:"system", status:"READY", layer:"ODIN", description:"Global Control Center для ODIN-ADMIN V02 PRO."},
    ...
    {id:"router", title:"Template Router", path:"ODIN_TREE_PROJECT_v1/00_CORE/ODIN_TEMPLATE_ROUTER_v1.md", type:"md", status:"LOCKED", layer:"CORE", description:"Визначає, який шаблон використовувати за task_type. Lesson → TEMPLATE_BASE_v1.html."}
  ]},
  { group:"ODIN TREE", items:[
    ...
    {id:"header", title:"03 HEADER LOCK", path:"ODIN_TREE_PROJECT_v1/03_HEADER_LOCK", type:"folder", status:"PARTIAL", layer:"HEADER", description:"Header lock система. Потребує повної інтеграції з ODIN_HEADER_LOCK_v1."},
