...
const odinMatrixI18n = {
  ua: {
    title: 'Інтерфейс ОДІН', subtitle: 'Робоче середовище керування системою', quickSettings: 'Швидкі налаштування', settings: 'Налаштування', systemPages: 'Сторінки системи', mainInterface: 'Головний інтерфейс', commitBuilder: 'Commit Builder', stateWorkspace: 'State Workspace', pageCommitBuilder: 'Commit Builder', pageStateWorkspace: 'State Workspace', zoneCommand: 'Командний центр', zoneMap: 'Карта системи', zoneProjects: 'Проєкти', zoneFiles: 'Робота з файлами', zoneManual: 'Інструкція', hintCommand: 'Головна робоча зона команд і сценаріїв.', hintMap: 'Жива карта системи ODIN та її зв’язків.', hintProjects: 'Розділ продуктів і проєктів ODIN.', hintFiles: 'Робота з файлами: editor, diff, preview, approve.', hintManual: 'Інструкції, правила і пояснення системи.', themeLabel: 'Тема', languageLabel: 'Мова', themeLightName: 'Світла', themeDarkName: 'Темна', treeTitle: 'Навігація', assistTitle: 'Пояснення', modeLabel: 'РЕЖИМ', stateLabel: 'СТАН', projectLabel: 'ПРОЄКТ', workflowLabel: 'ПРОЦЕС', modeDiscussion: 'ОБГОВОРЕННЯ', stateReady: 'ГОТОВО', none: 'Не вибрано', workflowApproved: 'Затверджено',
  ...
  en: {
    title: 'ODIN Interface', subtitle: 'System control workspace', quickSettings: 'Quick settings', settings: 'Settings', systemPages: 'System pages', mainInterface: 'Main Interface', commitBuilder: 'Commit Builder', stateWorkspace: 'State Workspace', pageCommitBuilder: 'Commit Builder', pageStateWorkspace: 'State Workspace', zoneCommand: 'Command Center', zoneMap: 'System Map', zoneProjects: 'Projects', zoneFiles: 'File Workspace', zoneManual: 'Manual', hintCommand: 'Main work zone for commands and scenarios.', hintMap: 'Live ODIN system map and dependencies.', hintProjects: 'ODIN products and projects area.', hintFiles: 'File work: editor, diff, preview, approve.', hintManual: 'System instructions, rules and explanations.', themeLabel: 'Theme', languageLabel: 'Language', themeLightName: 'Light', themeDarkName: 'Dark', treeTitle: 'Navigation', assistTitle: 'Explanation', modeLabel: 'MODE', stateLabel: 'STATE', projectLabel: 'PROJECT', workflowLabel: 'WORKFLOW', modeDiscussion: 'DISCUSSION', stateReady: 'READY', none: 'None selected', workflowApproved: 'Approved',
  ...
  de: {
    title: 'ODIN Interface', subtitle: 'Arbeitsbereich zur Systemsteuerung', quickSettings: 'Schnelleinstellungen', settings: 'Einstellungen', systemPages: 'Systemseiten', mainInterface: 'Hauptinterface', commitBuilder: 'Commit Builder', stateWorkspace: 'State Workspace', pageCommitBuilder: 'Commit Builder', pageStateWorkspace: 'State Workspace', zoneCommand: 'Kommandozentrale', zoneMap: 'Systemkarte', zoneProjects: 'Projekte', zoneFiles: 'Datei-Workspace', zoneManual: 'Handbuch', hintCommand: 'Hauptarbeitsbereich für Befehle und Szenarien.', hintMap: 'Live-Systemkarte von ODIN und Abhängigkeiten.', hintProjects: 'Bereich für ODIN-Produkte und Projekte.', hintFiles: 'Dateiarbeit: Editor, Diff, Vorschau, Freigabe.', hintManual: 'Systemanleitungen, Regeln und Erklärungen.', themeLabel: 'Theme', languageLabel: 'Sprache', themeLightName: 'Hell', themeDarkName: 'Dunkel', treeTitle: 'Navigation', assistTitle: 'Erklärung', modeLabel: 'MODUS', stateLabel: 'STATUS', projectLabel: 'PROJEKT', workflowLabel: 'ABLAUF', modeDiscussion: 'DISKUSSION', stateReady: 'BEREIT', none: 'Nicht ausgewählt', workflowApproved: 'Genehmigt',
